...
public func assertResultCount(_ result: [TDSRow], expectedCount: Int, file: StaticString = #filePath, line: UInt = #line) {
    XCTAssertEqual(result.count, expectedCount, file: file, line: line)
}

public func assertColumnExists(_ result: [TDSRow], columnName: String, file: StaticString = #filePath, line: UInt = #line) {
...
public func assertValue(_ result: [TDSRow], column: String, expectedValue: String, file: StaticString = #filePath, line: UInt = #line) {
...
public func assertValue(_ result: [TDSRow], column: String, expectedValue: Int, file: StaticString = #filePath, line: UInt = #line) {
    guard let row = result.first else {
        XCTFail("No rows found in result", file: file, line: line)
        return
    }
...
public func assertValue(_ result: [TDSRow], column: String, expectedValue: Bool, file: StaticString = #filePath, line: UInt = #line) {
    guard let row = result.first else {
        XCTFail("No rows found in result", file: file, line: line)
        return
    }
